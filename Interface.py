...
def insertUniv(Uname, Dname, yrs, lg, fee, lgfee):
    cursor.execute("INSERT INTO universities(UnivName, dept, years, language, fees, langFees) VALUES (?,?,?,?,?,?)",(Uname, Dname, yrs, lg, fee, lgfee))
...
def univMan():
    ...
    def SortUniv():
        ...
        search_result_label = Label(new_window1, text= "List of universities where you can study " + departement,font=label_font)
    ...
    #-------------------------------------------------------------------------------
    addBtn = Button(frame2, text="Add University", font=btn_font, bg='LightSkyBlue3', width=20, command= lambda:addUniv(tableUniv))
    addBtn.place(x=650, y=40)

    dltBtn = Button(frame2, text="Delete University", font=btn_font, bg='LightSkyBlue3', width=20, command= lambda:DeleteUniv(tableUniv))
...
UnivMangementBtn = Button(BottomFrame, text="Manage Universities", bg="LightSkyBlue3", font=btn_font, width=25, command=univMan)
